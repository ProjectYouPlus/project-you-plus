...
type TrainingContext = { trainingDays?:number[]; todayStatus?:string; activePlan: null | { title: string; goal: string; daysPerWeek: number; sessionMinutes: number; experience: string }; todaySession: null | { title: string; focus: string; duration: number; exercises: Array<{ name: string; sets: string; reps: string }> }; workoutsLast7Days: number; };
