...
- Treat the existing 1% Score as authoritative.
...
function contextFor(specialist:Specialist,context:UserContext){const d=context.domains;const shared={onePercentScore:context.score.score,scoreCoveragePct:context.score.coveragePct,scoreRationale:context.score.rationale,strongest:context.score.strongest,opportunity:context.score.opportunity,generatedAt:context.generatedAt};if(specialist==="planner")return{...shared,profile:d.profile,goals:d.goals,tasks:d.tasks,habits:d.habits,calendar:d.calendar,workSchedule:d.workSchedule,workout:d.workout};if(specialist==="health")return{...shared,workout:d.workout,nutrition:d.nutrition,supplements:d.supplements,health:d.health,recentPerformance:d.recentPerformance,eventHistory:d.eventHistory};if(specialist==="finance")return{...shared,finance:d.finance,recentScores:d.recentScores};return{...shared,recentScores:d.recentScores,recentPerformance:d.recentPerformance,achievements:d.achievements,progression:d.progression,eventHistory:d.eventHistory};}
