...
export interface Profile { createdAt?: string; id: string; fullName: string | null; timezone: string; onboardingCompleted: boolean; blueprint: { vision?: string; goals?: string[]; priorities?: string[]; habits?: string[]; coachingStyle?: string[]; rhythm?: { wakeTime?: string; sleepTime?: string; primaryActivity?: string }; healthEnergy?: string; financeContext?: string; availableDailyTime?: string; peakEnergy?: string; protectedCommitments?: string; nutritionPhotoTracking?: boolean; moneyGoals?: string[]; connectionPrefs?: string[]; } | null; }
