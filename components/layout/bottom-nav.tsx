...
export function BottomNav() {
  ...
  return <nav className="fixed bottom-[max(24px,env(safe-area-inset-bottom))] left-1/2 z-40 mx-auto grid w-[calc(100%-32px)] max-w-[520px] -translate-x-1/2 grid-cols-5 items-center rounded-[28px] border border-white/[.11] bg-[rgba(17,17,28,.72)] px-1.5 pb-[7px] pt-2 shadow-[0_24px_75px_rgba(0,0,0,.48)] backdrop-blur-[34px] backdrop-saturate-150 md:hidden">
