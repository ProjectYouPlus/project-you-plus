...
export function ConnectAccounts(){
  ...
  return <div className="space-y-4">
    <section className="py-glass-hero p-5"><h2 className="m-0 text-[22px] font-semibold tracking-[-.03em] text-white">Bring your financial picture into one place.</h2><p className="m-0 mt-2 text-[12.5px] leading-relaxed text-[#C2BED0]">Connect through Plaid or add balances manually. Project You+ never asks you to type a bank password into our app.</p><div className="mt-5"><PlaidLinkButton/></div><p className="m-0 mt-2 text-[10px] leading-relaxed text-[#9E97AC]">Plaid begins in Sandbox while we verify the full connection, consent, sync, and disconnect flows before production access.</p></section>
